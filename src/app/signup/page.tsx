    ...
    return (
      ...
      >
        <div
          ...
          style={{ maxWidth: "420px", padding: "48px", textAlign: "center", cursor: "default" }}
        >
          <div
            style={{
              width: 64,
          ...
          <Link
            ...
            style={{ textDecoration: "none", marginTop: "24px", display: "inline-block" }}
          >
            Go to Login
          </Link>
        </div>
  ...
  return (
    ...
    >
      <div style={{ width: "100%", maxWidth: "420px", animation: "fadeIn 0.5s ease-out" }}>
        ...
        <div className="glass-card" style={{ padding: "36px", cursor: "default" }}>
          {/* Google Signup */}
          <button
